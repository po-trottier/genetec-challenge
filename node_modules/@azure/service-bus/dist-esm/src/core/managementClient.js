...
import { SenderEvents, ReceiverEvents, types, message as RheaMessageUtil, generate_uuid, string_to_uuid } from "rhea-promise";
import { defaultLock, translate, Constants, RequestResponseLink, ConditionErrorNameMapper } from "@azure/amqp-common";
import { ServiceBusMessage, toAmqpMessage, getMessagePropertyTypeMismatchError } from "../serviceBusMessage";
import { LinkEntity } from "./linkEntity";
import * as log from "../log";
import { ReceiveMode, fromAmqpMessage } from "../serviceBusMessage";
import { toBuffer } from "../util/utils";
import { throwErrorIfConnectionClosed, throwTypeErrorIfParameterMissing, throwTypeErrorIfParameterNotLong, throwTypeErrorIfParameterTypeMismatch, throwTypeErrorIfParameterIsEmptyString, throwErrorIfClientOrConnectionClosed } from "../util/errors";
...
export class ManagementClient extends LinkEntity {
    ...
    constructor(context, options) {
        ...
        this.managementLock = `${Constants.managementRequestKey}-${generate_uuid()}`;
        /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (!this._isMgmtRequestResponseLinkOpen()) {
                    ...
                    log.mgmt("[%s] Created sender '%s' and receiver '%s' links for $management endpoint.", this._context.namespace.connectionId, this._mgmtReqResLink.sender.name, this._mgmtReqResLink.receiver.name);
                    yield this._ensureTokenRenewal();
                }
            }
            catch (err) {
                err = translate(err);
                log.error("[%s] An error occured while establishing the $management links: %O", this._context.namespace.connectionId, err);
                throw err;
            }
        });
    }
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                log.error("[%s] An error occurred while closing the management session: %O.", this._context.namespace.connectionId, err);
                throw err;
            }
        });
    }
    ...
    peekBySequenceNumber(fromSequenceNumber, maxMessageCount, sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                log.mgmt("[%s] Peek by sequence number request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
    ...
    renewLock(lockToken, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const error = translate(err);
                log.error("An error occurred while sending the renew lock request to $management " + "endpoint: %O", error);
                throw error;
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < messages.length; i++) {
                ...
                try {
                    ...
                    log.error("An error occurred while encoding the item at position %d in the messages array" + ": %O", i, error);
                    throw error;
                }
            }
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Schedule messages request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
    ...
    cancelScheduledMessages(sequenceNumbers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Cancel scheduled messages request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
    ...
    receiveDeferredMessages(sequenceNumbers, receiveMode, sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Receive deferred messages request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
    ...
    updateDispositionStatus(lockToken, dispositionStatus, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Update disposition status request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
    ...
    renewSessionLock(sessionId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                log.mgmt("[%s] Renew Session Lock request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
                ...
                log.mgmt("[%s] Lock for session '%s' will expire at %s.", this._context.namespace.connectionId, sessionId, lockedUntilUtc.toString());
                return lockedUntilUtc;
            }
            catch (err) {
                const error = translate(err);
    ...
    setSessionState(sessionId, state) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Set Session state request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
    ...
    getSessionState(sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Get session state request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
    ...
    listMessageSessions(skip, top, lastUpdatedTime) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] List sessions request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
    ...
    getRules() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Get rules request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
                ...
                const error = translate(err);
                log.error("An error occurred while sending the get rules request to $management " + "endpoint: %O", error);
                throw error;
            }
        });
    }
    ...
    removeRule(ruleName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Remove Rule request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
                ...
                const error = translate(err);
                log.error("An error occurred while sending the remove rule request to $management " + "endpoint: %O", error);
                throw error;
            }
        });
    }
    ...
    addRule(ruleName, filter, sqlRuleActionExpression) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                request.application_properties[Constants.trackingId] = generate_uuid();
                log.mgmt("[%s] Add Rule request body: %O.", this._context.namespace.connectionId, request.body);
                log.mgmt("[%s] Acquiring lock to get the management req res link.", this._context.namespace.connectionId);
                yield defaultLock.acquire(this.managementLock, () => {
                    return this._init();
                });
                ...
                const error = translate(err);
                log.error("An error occurred while sending the Add rule request to $management " + "endpoint: %O", error);
                throw error;
            }
        });
    }
