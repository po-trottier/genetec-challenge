...
export function getDispositionType(dispositionStatus) {
 ...
 */
export function getProcessorCount() {
    if (isNode) {
        const os = require("os");
 ...
 * @param value
 */
export function getCountDetailsOrUndefined(value) {
    if (value == undefined) {
        return undefined;
    }
    return {
...
function buildAuthorizationRule(value) {
    ...
    if (authorizationRule.rights.accessRights &&
